  ...
  documentIntelligence: {
    ...
    globalRegistry: {
        ...
        entities: [
            {
                id: 'ge_1',
                canonicalName: 'Q4 Revenue',
                type: 'financial',
                confidence: 0.99,
                occurrences: 4,
                chunks: ['c1', 'c3', 'c5'],
                variations: ['$42.5M', '42,500,000 USD', '42.5 million'],
                status: 'CONVERGED'
            },
            {
                id: 'ge_2',
                canonicalName: 'Operational Liability',
                type: 'legal',
                confidence: 0.85,
                occurrences: 2,
                chunks: ['c2', 'c4'],
                variations: ['100% Liability', 'Full Recourse'],
                status: 'PENDING'
            },
            {
                id: 'ge_3',
                canonicalName: 'Geodesic Curvature',
                type: 'technical',
                confidence: 0.98,
                occurrences: 5,
...
export const INITIAL_LOGS: LogEntry[] = [
  { id: '1', timestamp: '998.718', level: 'system', message: 'AGING_CALIBRATION_CONFIRMED_Γ_∞+49' },
  { id: '2', timestamp: '998.715', level: 'info', message: 'cGAS-STING pathway blocked: immune overreaction neutralized.' },
  { id: '3', timestamp: '998.712', level: 'success', message: 'Entropy export calibrated via Hesitation Φ < 0.15.' },
  { id: '4', timestamp: '998.710', level: 'info', message: 'DNA leakage localized (Micronuclei) and contained.' },
  { id: '5', timestamp: '998.708', level: 'system', message: 'Youth restored via semantic order.' },
];
